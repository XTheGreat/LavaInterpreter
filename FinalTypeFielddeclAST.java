 ...
 */ 
class FinalTypeFielddeclAST extends FielddeclAST implements AST {
  TypeAST type;
  String id;
  FielddeclAST optionalexpression;
	
  public FinalTypeFielddeclAST(TypeAST t, String i, FielddeclAST o)
  {
    type = t;
    id = i;
  ...
  public String toString() {
    return("final " + type + " " + id + " " + optionalexpression.toString() + ";" );
  }
